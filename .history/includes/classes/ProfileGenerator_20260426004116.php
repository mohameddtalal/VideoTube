...
return "<div class='profileContainer'>
  ...
  <li class='nav-item' >
    <button class='nav-link active' id='videos-tab' data-bs-toggle='tab' data-bs-target='#home-tab-pane' type='button' role='tab' aria-controls='home-tab-pane' aria-selected='true' href='#videos'>Home</button>
  </li>
  <li class='nav-item' >
