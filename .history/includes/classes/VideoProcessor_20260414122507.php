...
class VideoProcessor {
    ...
    private function insertVideoData($videoUploadData,$finalFilePath) {
        ...
        $query->bindValue(":title",$videoUploadData->getTitle());
        $query->bindValue(":uploadedBy",$videoUploadData->getUploadedBy());
        $query->bindValue(":description",$videoUploadData->getDescription());
        $query->bindValue(":privacy",$videoUploadData->getPrivacy());
        $query->bindValue(":category",$videoUploadData->getCategory());
        $query->bindValue(":filePath",$finalFilePath);
