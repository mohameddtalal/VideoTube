...
class VideoProcessor {
    ...
    private $ffmpegPath = "C:/xampp/htdocs/VideoTube/ffmpeg/windows/ffmpeg"; //path to ffmpeg
    ...
    public function convertVideoToMp4($tempFilePath,$finalFilePath) {
        $cmd = "C:/xampp/htdocs/VideoTube/ffmpeg/windows/ffmpeg -i $tempFilePath $finalFilePath"; //path to ffmpeg
