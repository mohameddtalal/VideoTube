...
class VideoProcessor {
    ...
    private function getVideoDuration($filePath) {
        ...
        foreach($outputLog as $line) {
            if(strpos($line, "Duration:") !== false) { //find duration line
                $duration = explode("Duration: ", $line)[1]; //get duration value
                $duration = explode(", ", $duration)[0]; //remove extra info
                return $duration; //return duration
            }
        }
        return false; //return false if duration not found
    }
