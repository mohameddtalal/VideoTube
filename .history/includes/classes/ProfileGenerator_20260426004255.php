...
return "<div class='profileContainer'>
  ...
  <li class='nav-item' >
    <button class='nav-link' id='about-tab' data-bs-toggle='tab' data-bs-target='#about' type='button' role='tab' aria-controls='profile-tab-pane' aria-selected='false' href='#about'>Profile</button>
  </li>
</ul>";
