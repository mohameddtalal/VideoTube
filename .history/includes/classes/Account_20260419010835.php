...
class Account {
    ...
    public function insertUserDetails($firstName, $lastName, $username, $email, $password) {
       $password = hash("sha512", $password);
        ...
        $query = $this->con->prepare("INSERT INTO users (firstName, lastName, username, email, password, profilePic, signUpDate) VALUES (:firstName, :lastName, :username, :email, :password, :profilePic, :signUpDate)");
