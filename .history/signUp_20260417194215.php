...
if(isset($_POST["submitButton"])) {
    ...
    $lastName = santizeFo   rmString($_POST["lastName"]);
    $username = santizeFormString($_POST["username"]);
    $email = santizeFormString($_POST["email"]);
    $email2 = santizeFormString($_POST["email2"]);
    $password = santizeFormString($_POST["password"]);
    $password2 = santizeFormString($_POST["password2"]);
