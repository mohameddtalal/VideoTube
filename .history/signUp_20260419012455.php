    ...
    <div class="column">
        ...
        <div class="loginForm">
            <form action="signUp.php" method="POST">
                ...
                <input type="email" name="email" placeholder="Email" value="<?php getInputValue('email'); ?>" required autocomplete="off">               
                <input type="email" name="email2" placeholder="Confirm Email" value="<?php getInputValue('email2'); ?>" required autocomplete="off">
