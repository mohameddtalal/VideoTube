...
class VideoDetailsFormProvider {   
    ...
    private function createDescriptionInput($value) {
        if($value==null) $value="";
        return "<div class='mb-3'>
        <textarea class='form-control' placeholder='Description' name='descriptionInput' rows='3' required>$value</textarea>
        </div>";
    }
    ...
    private function createPrivacyInput($value) {
        ...
        $privatSelected=($value==0)? "selected=' selected '":"";
        $publicSelected=($value==1)? "selected=' selected '":"";

        return "<div class='mb-3'>
        <select class='form-control'  name='privacyInput'>
            <option value='0' $privatSelected>Private</option>
